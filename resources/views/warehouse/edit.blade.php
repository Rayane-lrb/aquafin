            ...
            <form action="{{ route('warehouse.update', $warehouse->id) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input id="address-input" type="text" name="address" value="{{ old('address', $warehouse->address) }}"
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input id="lat-input" type="number" name="latitude" value="{{ old('latitude', $warehouse->latitude) }}" step="0.0000001"
                            placeholder="Breedtegraad"
                            class="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500">
                        <input id="lon-input" type="number" name="longitude" value="{{ old('longitude', $warehouse->longitude) }}" step="0.0000001"
