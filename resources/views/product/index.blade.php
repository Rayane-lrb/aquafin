<x-app-layout>
    ...
    <div class="flex justify-between items-center mb-6">
        <p class="text-sm text-gray-500">Liste de tous les produits disponibles</p>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 flex gap-3">
                        <a href="{{ route('product.edit', $product->id) }}" class="text-blue-600 hover:underline">Modifier</a>
                        <form action="{{ route('product.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Supprimer ce produit ?')">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-400">Aucun produit pour le moment.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
